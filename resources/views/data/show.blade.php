                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-11 mb-3">
                                ...
                                name="nama" id="nama" value="{{ $item->nama }}" disabled>
                            </div>
                            <div class="col-md-11 mb-3">
                                <label for="nomorSurat" class="form-label">Nomor Surat</label>
                                <input class="form-control" type="text"
                                name="nomorSurat" id="nomorSurat" value="{{ $item->nomorSurat }}" disabled>
                            </div>
                            <div class="col-md-11 mb-3">
                                <label for="divisi" class="form-label">Divisi</label>
                                <input class="form-control" type="text"
                                name="divisi" id="divisi" value="{{$divisions->firstWhere('id', $item->divisions_id)->nama}}" disabled>
                            </div>
                            <div class="col-md-11 mb-3">
                                <label for="kategori" class="form-label">Kategori</label>
                                <input class="form-control" type="text"
                                name="kategori" id="kategori" value="{{ $kategoris->firstWhere('id', $item->kategoris_id)->nama}}" disabled>
                            </div>
                            <div class="col-md-11 mb-3">
                                <label for="keterangan" class="form-label">Keterangan</label>
                                <input class="form-control" type="text"
                                name="keterangan" id="keterangan" value="{{ $item->keterangan }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
