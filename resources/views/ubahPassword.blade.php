...
@section('content')
    <div class="container-md mt-5">
        <form method="POST" action="{{ route('profile.updatePassword', $user->id) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <input id="current_password" name="current_password" type="password"
                        ...
                        autocomplete="current_password" placeholder="Masukkan Kata Sandi Lama">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <input id="new_password" name="new_password" type="password"
                        ...
                        autocomplete="new_password" placeholder="Masukkan Kata Sandi Baru">
            ...
            <div class="row mb-3">
                <label for="new_password_confirmation" class="col-md-4 col-form-label text-md-start">Konfirmasi Kata Sandi
                    Baru</label>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <input id="new_password_confirmation" name="new_password_confirmation" type="password"
                        class="form-control" required autocomplete="new_password_confirmation"
